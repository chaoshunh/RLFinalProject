...
In this problem, we define the i-th child in line $c$ as a task instance, $x_{i,c}$, which has two constraints--one for their desire, $c_1(x_{i,c})$, and the other for their patience, $c_2(x_{i,c})$. 
