...
\begin{document}
\onehalfspacing
\title{A Reinforcement Learning Approach to the Constrained Resource Allocation Problem}
...
\begin{abstract}
	This paper proposes a generalized framework to solve constrained resource allocation problem using a modified reinforcement learning algorithm. 
\end{abstract}
